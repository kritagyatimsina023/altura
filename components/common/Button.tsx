...
//       : variant === "outline"
//         ? "group-hover:bg-transparent group-hover:border-transparent group-hover:shadow-none"
//         : "group-hover:bg-transparent group-hover:border-transparent group-hover:shadow-none"
//   } relative group h-12 ${className || ""}`;
//   const content = (
//     <>
...
//               variant === "outline"
//                 ? "fill-[#FB923C] stroke-current stroke-2"
//                 : "fill-current"
//             } ${boneColor}`}
//           >
//             <path
...
//             variant === "outline"
//               ? "border-y-1 border-primary bg-transparent border-[#FB923C]"
//               : variant === "solid"
//                 ? "bg-primary"
//                 : "bg-white"
//           }`}
